package com.ziyoujiayuan.happygarden.controller.remind;
...
public class RemindController extends BaseController {
    ...
    public AjaxTableResult query(RemindQueryParam remindQueryParam) {
        return new AjaxTableResult(AjaxResultEnum.SUCCESS.getCode(), AjaxResultEnum.SUCCESS.getMessage(), true, null, remindQueryParam.getDraw());
    }
