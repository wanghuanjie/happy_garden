 ...
 * @author 
 */
public class ReplaceSoilRecordPO extends BasePO {
    /**
     * 记录ID
     */
    ...
    public boolean equals(Object that) {
        ...
        ReplaceSoilRecordPO other = (ReplaceSoilRecordPO) that;
        return (this.getRecordId() == null ? other.getRecordId() == null : this.getRecordId().equals(other.getRecordId()))
            && (this.getFlowerId() == null ? other.getFlowerId() == null : this.getFlowerId().equals(other.getFlowerId()))
            && (this.getBaseSoilId() == null ? other.getBaseSoilId() == null : this.getBaseSoilId().equals(other.getBaseSoilId()))
