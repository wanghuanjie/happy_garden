 ...
 * @author 
 */
public class SpreadDrugRecordPO extends BasePO {
    /**
     * 记录ID
     */
    ...
    public boolean equals(Object that) {
        ...
        SpreadDrugRecordPO other = (SpreadDrugRecordPO) that;
        return (this.getRecordId() == null ? other.getRecordId() == null : this.getRecordId().equals(other.getRecordId()))
            && (this.getFlowerId() == null ? other.getFlowerId() == null : this.getFlowerId().equals(other.getFlowerId()))
            && (this.getBaseDrugId() == null ? other.getBaseDrugId() == null : this.getBaseDrugId().equals(other.getBaseDrugId()))
            && (this.getDrugQuantity() == null ? other.getDrugQuantity() == null : this.getDrugQuantity().equals(other.getDrugQuantity()))
